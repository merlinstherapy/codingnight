...
const phases = [
  {
    dot: "#9fd3c9",
    label: "WARM-UP",
    tag: "Mobilize before load",
    exercises: "Cat–Cow · ×10    Pelvic Tilt · 2×12",
    color: "#1f7a6d",
    tagBg: "#e7f1ef",
  },
  {
    dot: "#1f7a6d",
    label: "ACTIVATE",
    tag: "Switch on the right muscles",
    exercises: "Glute Bridge · 3×12",
    color: "#1f7a6d",
    tagBg: "#e7f1ef",
  },
  {
    dot: "#155e54",
    label: "STABILIZE",
    tag: "Control under fatigue",
    exercises: "Bird Dog · 3×10    McGill Curl-up · 2×8",
    color: "#155e54",
    tagBg: "#e7f1ef",
  },
  {
    ...
    label: "COOL-DOWN",
    tag: "Release & breathe",
    exercises: "Child's Pose · hold 40s ×2",
    color: "#c2693f",
    tagBg: "#f7ebe2",
  },
];
    ...
    <PhoneShell>
      <div style={{ position: "absolute", inset: "52px 0 90px 0", padding: "10px 22px 0", overflowY: "auto" }}>
        ...
        <div style={{ color: "#6f6a63", fontSize: 13.5, marginTop: 3 }}>
          Reordered from your physio&apos;s list to optimize recovery.
        </div>
        ...
        <div style={{ marginTop: 18, position: "relative", paddingLeft: 30 }}>
          ...
          <div
            style={{
              ...
              bottom: 8,
              width: 2,
              background: "linear-gradient(#9fd3c9,#1f7a6d 45%,#155e54 70%,#d2774e)",
            }}
          />
            ...
            <div key={p.label} style={{ position: "relative", marginBottom: i < phases.length - 1 ? 13 : 0 }}>
              ...
              >
                ...
                <div style={{ marginTop: 8, fontSize: 13, color: "#3f3c37", lineHeight: 1.5 }}>
                  {p.exercises.split("    ").map((ex, j) => (
                    <span key={j}>
                      {j > 0 && <span>&nbsp;&nbsp;</span>}
                      <b>{ex.split(" · ")[0]}</b> · {ex.split(" · ")[1]}
                    </span>
                  ))}
                </div>
              </div>
